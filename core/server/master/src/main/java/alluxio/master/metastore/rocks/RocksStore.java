...
public final class RocksStore implements Closeable {
   ...
   */
  public RocksStore(String dbPath, String backupPath, Collection<ColumnFamilyDescriptor> columnFamilyDescriptors,
      DBOptions dbOpts) {
    mDbPath = dbPath;
   ...
   */
  public ColumnFamilyHandle getColumn(String columnName) {
