...
public class InvalidArgumentException extends AlluxioStatusException {
  ...
  private static final ExceptionStatus STATUS = ExceptionStatus.INVALID_ARGUMENT_EXCEPTION;
   ...
   */
  public InvalidArgumentException(ExceptionStatus status, Throwable cause) {
