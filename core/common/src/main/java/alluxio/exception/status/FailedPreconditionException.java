...
public class FailedPreconditionException extends AlluxioStatusException {
  ...
  private static final ExceptionStatus STATUS = ExceptionStatus.FAILED_PRECONDTION;
   ...
   */
  public FailedPreconditionException(ExceptionStatus status, Throwable cause) {
